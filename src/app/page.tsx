...
const HERO_VIDEO_URL = "https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/video-1766457434494.mp4"
...
const StarIcon = ({ filled }: { filled: boolean }) => (
  <svg className={`w-4 h-4 ${filled ? 'text-yellow-400' : 'text-zinc-300'}`} fill="currentColor" viewBox="0 0 20 20">
...
const GoogleReviews = () => {
  ...
  useEffect(() => {
    fetch('/api/reviews')
      .then(res => res.json())
      .then(data => {
        if (data.reviews) setReviews(data)
      })
      .catch(() => {})
  }, [])
  ...
  if (!reviews || reviews.reviews.length === 0) {
    return (
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[0, 1, 2].map(i => (
          <div key={i} className="bg-white p-10 rounded-[3rem] shadow-sm border border-black/[0.02] animate-pulse">
    ...
    <>
      <div className="flex items-center justify-center gap-3 mb-12">
        ...
        <div className="flex items-center gap-1">
          {[1, 2, 3, 4, 5].map(s => (
            <StarIcon key={s} filled={s <= Math.round(reviews.rating)} />
          ))}
        </div>
        <span className="text-[#4A583E] font-medium text-sm">{reviews.rating.toFixed(1)}</span>
...
const HeroVideo = () => {
  ...
  return (
    <video
      ...
      playsInline
      preload="auto"
      poster="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/7-3-scaled.png"
          ...
          <div className="suppis-container" id="suppis-container">
            ...
            <div className="service-item item-marcenaria">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/marcenaria.jpeg" alt="Marcenaria" />
              </div>
            ...
            <div className="service-item item-iluminacao">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/iluminacao.jpeg" alt="Iluminação" />
              </div>
            ...
            <div className="service-item item-gesso">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/Gesso.png" alt="Gesso" />
              </div>
            ...
            <div className="service-item item-marmoraria">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/Marmoraria.jpeg" alt="Marmoraria" />
              </div>
            ...
            <div className="service-item item-pisos">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/Pisos.jpeg" alt="Pisos e Revestimentos" />
              </div>
            ...
            <div className="service-item item-metais">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/METEAIS.jpeg" alt="Metais" />
              </div>
            ...
            <div className="service-item item-cortinas">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/CORTINAS.jpeg" alt="Cortinas e Persianas" />
              </div>
            ...
            <div className="service-item item-eletrica">
              <div className="service-circle">
                <img src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/Eletrica.jpeg" alt="Elétrica" />
              </div>
    ...
    <div className="min-h-screen bg-[#faf9f6] text-zinc-900 selection:bg-[#4A583E] selection:text-white font-light overflow-x-hidden">
          ...
          <div className="flex items-center gap-4 xl:gap-10">
            {[
              ...
              <a
                key={item.label}
                href={item.href}
                className={`uppercase font-semibold transition-all hover:opacity-50 whitespace-nowrap ${
                  isScrolled ? 'text-zinc-600 text-[11px] tracking-[0.1em]' : 'text-zinc-100 text-[13px] tracking-[0.25em]'
                }`}
              >
                {item.label}
              </a>
              ...
              <Button
                onClick={() => window.open('https://wa.me/5547997623154?text=Olá!%20Vi%20o%20site%20e%20gostaria%20de%20falar%20com%20um%20especialista.', '_blank')}
      ...
      <div className={`fixed left-0 right-0 z-[100] lg:hidden transition-all duration-500 ${
        isScrolled
          ...
          : 'top-0 w-full bg-transparent pt-8 pb-3'
      }`}>
        ...
        <div className="container mx-auto px-4 relative z-10 md:pl-28 mt-8 lg:mt-0 [@media(max-width:1024px)_and_(orientation:landscape)]:pt-12">
          <div className="max-w-4xl">
            ...
            >
              ...
              >
                <Button
                  onClick={() => window.open('https://wa.me/5547997623154?text=Olá!%20Gostaria%20de%20falar%20com%20um%20especialista%20sobre%20meu%20imóvel.', '_blank')}
                  ...
                  <svg className="mr-2 w-5 h-5 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
            ...
            <div className="relative">
              <motion.div 
                ...
                variants={slideInLeft}
                  className="relative aspect-[16/12] rounded-[3rem] overflow-hidden shadow-2xl"

              >
                <Image
                  src="https://kgmputkxbsuyxkssesmi.supabase.co/storage/v1/object/public/media/suppis/7-3-scaled.png"
      ...
      <section id="servicos" className="py-32 bg-[#faf9f6] relative overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-20 flex justify-center">
            ...
            >
              <Button 
                onClick={() => window.open('https://wa.me/5547997623154?text=Olá!%20Quero%20começar%20meu%20projeto%20com%20a%20Suppis.%20Como%20funciona?', '_blank')}
      ...
      <section id="sobre" className="py-24 md:py-32 bg-[#1A1F16] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 lg:pr-10 relative">
              <motion.div 
              ...
              >
                ...
                <div className="space-y-6 text-zinc-400 text-base md:text-lg font-light leading-relaxed">
                  ...
                  <motion.div variants={fadeIn} custom={4} className="pt-4">
                    <Button 
                      onClick={() => window.open('https://wa.me/5547997623154', '_blank')}
              ...
              >
                ...
                <div className="space-y-8 text-zinc-400 text-base md:text-lg font-light leading-relaxed">
                  ...
                  <motion.div variants={fadeIn} custom={3} className="flex flex-col sm:flex-row gap-4 pt-4">
                    <Button 
                      onClick={() => window.open('https://wa.me/5547997623154?text=Olá!%20Gostaria%20de%20solicitar%20um%20orçamento%20para%20meu%20projeto.', '_blank')}
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <motion.a 
                custom={1}
                variants={fadeIn}
                href="https://wa.me/5547997623154?text=Olá!%20Vi%20o%20site%20da%20Suppis%20e%20gostaria%20de%20mais%20informações." 
                target="_blank"
                className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all border border-white/5"
              >
        ...
        <div className="bg-white/90 backdrop-blur-2xl border-t border-zinc-200/50 shadow-[0_-4px_30px_rgba(0,0,0,0.08)]">
          <div className="grid grid-cols-5 items-start px-1 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))]">
            {[
              ...
              { label: 'Contato', href: 'https://wa.me/5547997623154?text=Olá!%20Vi%20o%20site%20e%20gostaria%20de%20falar%20com%20um%20especialista.', icon: Phone, isExternal: true },
            ].map((item) => {
