          ...
          <div className="bg-[#4A583E] rounded-[3rem] md:rounded-[4rem] p-8 md:p-20 overflow-hidden relative shadow-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center relative z-10">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                variants={scaleIn}
                className="relative aspect-[4/3] md:aspect-square rounded-3xl overflow-hidden shadow-2xl border-8 border-white/5"
              >
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3574.9657!2d-48.8475!3d-26.3032!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94deb0402b85e05d%3A0xc3f7a26245a4a58d!2sR.%20Dr.%20Marinho%20Lobo%2C%2023%20-%20Centro%2C%20Joinville%20-%20SC%2C%2089201-020!5e0!3m2!1spt-BR!2sbr!4v1736173000000!5m2!1spt-BR!2sbr" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
