        ...
        <div className={`mx-auto h-full flex items-center justify-between transition-all duration-500 ${isScrolled ? 'w-full px-2' : 'container px-6'}`}>
          ...
          <div className="flex items-center gap-4 xl:gap-10">
            {[
              ...
              <Button
                onClick={() => window.open('https://tintim.link/whatsapp/0cdc7886-686e-4429-b608-0e476b585a71/3841903f-4548-448d-97dd-c86e2f1ca15e', '_blank')}
        ...
        <div className="bg-white/90 backdrop-blur-2xl border-t border-zinc-200/50 shadow-[0_-4px_30px_rgba(0,0,0,0.08)]">
          <div className="grid grid-cols-5 items-start px-1 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))]">
            {[
              ...
              { label: 'Contato', href: 'https://tintim.link/whatsapp/0cdc7886-686e-4429-b608-0e476b585a71/3841903f-4548-448d-97dd-c86e2f1ca15e', icon: Phone, isExternal: true },
            ].map((item) => {
