...
export function SuppisIntegra() {
  ...
  return (
    <section id="suppis-integra" className="bg-white relative overflow-hidden flex flex-col items-center justify-center py-24 md:py-32">
